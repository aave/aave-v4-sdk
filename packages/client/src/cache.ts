...
export const exchange = cacheExchange({
  ...
  resolvers: {
    ...
    LeverageActivity: {
      timestamp: transformToDate,
      multiplier: transformToBigDecimal,
    },
    Leverage: {
      multiplier: transformToBigDecimal,
    },
    LeverageApprovalsRequired: {
      maxSafeMultiplier: transformToBigDecimal,
    },
  ...
  keys: {
    ...
    LeverageActivity: (data: LeverageActivity) => data.id,
    ...
    OrderFulfilled: () => null,
    OrderOpen: () => null,
    OrderPendingSignature: () => null,
    OrderPositionManagerApproval: () => null,
    OrderQuote: () => null,
    OrderQuoteCosts: () => null,
    OrderReceipt: () => null,
    OrderSetCollateralApproval: () => null,
    OrderTransactionRequest: () => null,
    OrderTypedData: () => null,
