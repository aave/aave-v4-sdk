...
> = {
  ...
  [ActivityType.UpdatedLiquidationConfig]: 'UpdatedLiquidationConfigActivity',
  [ActivityType.UpdatedPriceSource]: 'UpdatedPriceSourceActivity',
  [ActivityType.UpdatedReserveConfig]: 'UpdatedReserveConfigActivity',
  [ActivityType.UpdatedSpokeConfig]: 'UpdatedSpokeConfigActivity',
  [ActivityType.UpdatedPositionManager]: 'UpdatedPositionManagerActivity',
...
const skipActivityTypes = [
  ...
  // governance config changes, which a test wallet cannot produce
  ActivityType.UpdatedLiquidationConfig,
  ActivityType.UpdatedPriceSource,
  ActivityType.UpdatedReserveConfig,
  ActivityType.UpdatedSpokeConfig,
  ActivityType.UpdatedPositionManager,
