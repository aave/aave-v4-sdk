...
describe('Repay Position swapping on Aave V4', () => {
  describe('Given a user with a supply position enable as collateral', () => {
    describe('And the user has a borrow position', () => {
      ...
      describe('And the user has a another supply position with a different token as the borrowed', () => {
