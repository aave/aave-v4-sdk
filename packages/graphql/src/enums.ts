 ...
 */
export enum UserActivityFeedType {
  Borrow = 'BORROW',
  Supply = 'SUPPLY',
  Withdraw = 'WITHDRAW',
  Repay = 'REPAY',
...
/**
 * @deprecated Use `UserActivityFeedType` instead.
 */
export type ActivityType = UserActivityFeedType;
/**
 * @deprecated Use `UserActivityFeedType` instead.
 */
export const ActivityType = UserActivityFeedType;
