...
running command...
$ aave (--version)
@aave/cli/4.1.0-next.16 darwin-arm64 node-v22.17.0
$ aave --help [COMMAND]
USAGE
  $ aave COMMAND
...
...
_See code: [src/commands/hubs/list.ts](https://github.com/aave/aave-v4-sdk/blob/v4.1.0-next.16/src/commands/hubs/list.ts)_
...
_See code: [src/commands/reserves/list.ts](https://github.com/aave/aave-v4-sdk/blob/v4.1.0-next.16/src/commands/reserves/list.ts)_
...
_See code: [src/commands/spokes/list.ts](https://github.com/aave/aave-v4-sdk/blob/v4.1.0-next.16/src/commands/spokes/list.ts)_
<!-- commandsstop -->
